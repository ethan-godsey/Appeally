  ...
  <div class="instructions-page">
    ...
    <div class="step-list">
      <div class="step">
        ...
        <div class="step-body">
          <strong>Print the appeal letter</strong>
          <p>Print the letter on standard 8.5" × 11" white paper. Sign your name where indicated before mailing.</p>
        </div>
      </div>
      <div class="step">
      ...
      <div class="step">
        ...
        <div class="step-body">
          <strong>Mail via Certified Mail with Return Receipt</strong>
          <p>At your post office, request <strong>USPS Certified Mail</strong> with <strong>Return Receipt (Form 3811)</strong>. Keep the tracking number and the green receipt card when it comes back — this is your legal proof of delivery.</p>
        </div>
      </div>
      <div class="step">
        <div class="step-num">4</div>
        <div class="step-body">
          <strong>Send to the insurer's appeals department</strong>
      ...
      <div class="step">
        ...
        <div class="step-body">
          ...
          <p>File a copy of the signed letter, all enclosures, and your certified mail receipt. If your appeal is denied again, this packet is your evidence for escalation.</p>
        </div>
      </div>
      <div class="step">
        ...
        <div class="step-body">
          ...
          <p>File a complaint with the <strong>U.S. Department of Labor Employee Benefits Security Administration (EBSA)</strong> at <strong>dol.gov/EBSA</strong> or call 1-866-444-3272. Also file with your <strong>State Insurance Commissioner</strong>.</p>
        </div>
      </div>
    </div>
